...
To report unacceptable behavior, open an issue (if safe to do so) or use the private reporting channel described in `SECURITY.md`. All reports will be reviewed and investigated promptly and fairly.
...
2. **Warning**: A warning with consequences for continued behavior. No interaction with the community for a specified period of time.
